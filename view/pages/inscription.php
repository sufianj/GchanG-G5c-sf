...
<div id="page">
    ...
    <article>
            ...
            <tr>
                ...
                <td>
                    ...
                    if(isset($_POST['6_letters_code'])){
                        codeVeriBon($_SESSION['6_letters_code'], $_POST['6_letters_code']);
                    }
                    ?>
                </td>
                <td>
        ...
        if(isset($_POST['6_letters_code']) && isset($_POST['valider']) && isset($_POST['pseudo']) && isset($_POST['email']) && isset($_POST['mdp']) && isset($_POST['mdpv'])){
