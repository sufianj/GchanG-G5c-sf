...
if(isset($_POST['pseudo']) && isset($_POST['mdp'])){ 
    ...
    $mdp = $_POST['mdp'];
    $reponse = $bdd->query("SELECT idClient,Admin,Pseudo,NomUtilisateur,PrenomUtilisateur,Pwd,AdresseMail FROM client WHERE Pseudo='$_POST[pseudo]' AND Pwd=SHA1('$mdp')");
	...
	$_SESSION['admin'] = $donnees['Admin'];
        ...
        echo '<script language="javascript">alert("pseudo ou mdp erreur");</script>';
}
